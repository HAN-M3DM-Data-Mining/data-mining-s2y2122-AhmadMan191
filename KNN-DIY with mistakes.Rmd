...
cleanDF <- select(cleanDF, -Age, -CHOL, -ALP, -ALT, -PROT, -ALB, -BIL, -CREA, -CHE)
```
...
```{r}
cleanDF$Category <- factor(cleanDF$Category, levels = c("0=Blood Donor", "1=Hepatitis", "0s=suspect Blood Donor"), labels = c("Blood Donor", "Hepatitis", "suspect Blood Donor", "Fibrosis ")) %>% relevel("Blood Donor")
...
testDF_labels <- cleanDF[480:557,  1]
